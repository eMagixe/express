...
const styles = {
  "pages/index.vue": () => import('../build/index-styles.C58yg_XY.mjs').then(interopDefault),
  ...
  "components/section/welcome.vue": () => import('../build/welcome-styles.L-hSX-iJ.mjs').then(interopDefault),
