...
const styles = {
  "pages/index.vue": () => import('../build/index-styles.Dl_7wk8T.mjs').then(interopDefault),
  ...
  "components/section/welcome.vue": () => import('../build/welcome-styles.4CG-rp7b.mjs').then(interopDefault),
  "layouts/empty.vue": () => import('../build/empty-styles.Dh3EOWO7.mjs').then(interopDefault),
  "components/section/advantages.vue": () => import('../build/advantages-styles.DIehq_fB.mjs').then(interopDefault),
