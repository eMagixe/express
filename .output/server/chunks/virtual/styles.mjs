...
const styles = {
  "pages/index.vue": () => import('../build/index-styles.l_XE_g3S.mjs').then(interopDefault),
  ...
  "components/order/create.vue": () => import('../build/create-styles.Bhoel37N.mjs').then(interopDefault),
  "components/section/welcome.vue": () => import('../build/welcome-styles.BcJXKvFR.mjs').then(interopDefault),
  "components/section/advantages.vue": () => import('../build/advantages-styles.BHQjN6zW.mjs').then(interopDefault),
  ...
  "components/call.vue": () => import('../build/call-styles.fDiwUxhY.mjs').then(interopDefault),
  "components/section/questions.vue": () => import('../build/questions-styles.CFndvZTp.mjs').then(interopDefault),
  "components/section/order.vue": () => import('../build/order-styles.DLaSTFGU.mjs').then(interopDefault)
};
