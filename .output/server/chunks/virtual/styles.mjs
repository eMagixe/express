...
const styles = {
  "pages/index.vue": () => import('../build/index-styles.CwfdeeFB.mjs').then(interopDefault),
  ...
  "components/section/welcome.vue": () => import('../build/welcome-styles.sZWk-3_0.mjs').then(interopDefault),
  ...
  "components/call.vue": () => import('../build/call-styles.Klx9RQnK.mjs').then(interopDefault),
