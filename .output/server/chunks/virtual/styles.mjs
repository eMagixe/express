...
const styles = {
  "pages/index.vue": () => import('../build/index-styles.CeHqlBor.mjs').then(interopDefault),
  ...
  "components/section/welcome.vue": () => import('../build/welcome-styles.CdaCxSBs.mjs').then(interopDefault),
