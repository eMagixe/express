...
const styles = {
  "pages/index.vue": () => import('../build/index-styles.C5CFIpab.mjs').then(interopDefault),
  ...
  "components/section/welcome.vue": () => import('../build/welcome-styles.FkI66mH9.mjs').then(interopDefault),
  "components/section/advantages.vue": () => import('../build/advantages-styles.CVbeYoPQ.mjs').then(interopDefault),
  ...
  "components/call.vue": () => import('../build/call-styles.NZtSXV0H.mjs').then(interopDefault),
