...
import { u as useComponentProps, t as tv, P as Primitive, _ as _sfc_main$5, b as _sfc_main$2 } from './Button-D7hwtKF6.mjs';
import { createReusableTemplate } from '@vueuse/core';
import { _ as _sfc_main$1 } from './Badge-B8ag0XyV.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (unref(props).discount || unref(props).price || !!slots.discount || !!slots.price || unref(props).billingCycle || unref(props).billingPeriod || !!slots.billing) {
              _push2(`<div data-slot="priceWrapper" class="${ssrRenderClass(ui.value.priceWrapper({ class: unref(props).ui?.priceWrapper }))}"${_scopeId}>`);
              if (unref(props).discount && unref(props).price || !!slots.discount) {
                _push2(`<div data-slot="discount" class="${ssrRenderClass(ui.value.discount({ class: unref(props).ui?.discount }))}"${_scopeId}>`);
                ssrRenderSlot(_ctx.$slots, "discount", {}, () => {
                  _push2(`${ssrInterpolate(unref(props).price)}`);
              ...
              if (unref(props).discount || unref(props).price || !!slots.price) {
                _push2(`<div data-slot="price" class="${ssrRenderClass(ui.value.price({ class: unref(props).ui?.price }))}"${_scopeId}>`);
                ssrRenderSlot(_ctx.$slots, "price", {}, () => {
                  _push2(`${ssrInterpolate(unref(props).discount || unref(props).price)}`);
                }, _push2, _parent2, _scopeId);
                _push2(`</div>`);
              } else {
                _push2(`<!---->`);
              ...
              if (unref(props).billingCycle || unref(props).billingPeriod || !!slots.billing) {
                _push2(`<div data-slot="billing" class="${ssrRenderClass(ui.value.billing({ class: unref(props).ui?.billing }))}"${_scopeId}>`);
                ssrRenderSlot(_ctx.$slots, "billing", { ui: ui.value }, () => {
                  _push2(`<span data-slot="billingPeriod" class="${ssrRenderClass(ui.value.billingPeriod({ class: unref(props).ui?.billingPeriod }))}"${_scopeId}>${ssrInterpolate(unref(props).billingPeriod || " ")}</span>`);
                  if (unref(props).billingCycle) {
                    _push2(`<span data-slot="billingCycle" class="${ssrRenderClass(ui.value.billingCycle({ class: unref(props).ui?.billingCycle }))}"${_scopeId}>${ssrInterpolate(unref(props).billingCycle)}</span>`);
                  } else {
                    _push2(`<!---->`);
                  }
                }, _push2, _parent2, _scopeId);
            ...
            return [
              unref(props).discount || unref(props).price || !!slots.discount || !!slots.price || unref(props).billingCycle || unref(props).billingPeriod || !!slots.billing ? (openBlock(), createBlock("div", {
                key: 0,
                ...
                unref(props).discount && unref(props).price || !!slots.discount ? (openBlock(), createBlock("div", {
                  ...
                  renderSlot(_ctx.$slots, "discount", {}, () => [
                    createTextVNode(toDisplayString(unref(props).price), 1)
                  ])
                ...
                unref(props).discount || unref(props).price || !!slots.price ? (openBlock(), createBlock("div", {
                  ...
                  renderSlot(_ctx.$slots, "price", {}, () => [
                    createTextVNode(toDisplayString(unref(props).discount || unref(props).price), 1)
                  ])
                ], 2)) : createCommentVNode("", true),
                unref(props).billingCycle || unref(props).billingPeriod || !!slots.billing ? (openBlock(), createBlock("div", {
                  ...
                  renderSlot(_ctx.$slots, "billing", { ui: ui.value }, () => [
                    ...
                    }, toDisplayString(unref(props).billingPeriod || " "), 3),
                    unref(props).billingCycle ? (openBlock(), createBlock("span", {
                      key: 0,
                      "data-slot": "billingCycle",
                      class: ui.value.billingCycle({ class: unref(props).ui?.billingCycle })
                    }, toDisplayString(unref(props).billingCycle), 3)) : createCommentVNode("", true)
                  ])
                ], 2)) : createCommentVNode("", true)
              ], 2)) : createCommentVNode("", true)
            ];
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderSlot(_ctx.$slots, "body", {}, () => {
              _push2(`<div data-slot="titleWrapper" class="${ssrRenderClass(ui.value.titleWrapper({ class: unref(props).ui?.titleWrapper }))}"${_scopeId}>`);
              ...
              if (unref(props).orientation === "vertical") {
                _push2(ssrRenderComponent(unref(ReusePriceTemplate), null, null, _parent2, _scopeId));
              } else {
                _push2(`<!---->`);
              }
              if (features.value?.length || !!slots.features) {
                _push2(`<ul data-slot="features" class="${ssrRenderClass(ui.value.features({ class: unref(props).ui?.features }))}"${_scopeId}>`);
                ssrRenderSlot(_ctx.$slots, "features", {}, () => {
                  _push2(`<!--[-->`);
                  ssrRenderList(features.value, (feature, index) => {
                    _push2(`<li data-slot="feature" class="${ssrRenderClass(ui.value.feature({ class: unref(props).ui?.feature }))}"${_scopeId}>`);
                    ...
                    _push2(`<span data-slot="featureTitle" class="${ssrRenderClass(ui.value.featureTitle({ class: unref(props).ui?.featureTitle }))}"${_scopeId}>${ssrInterpolate(feature.title)}</span></li>`);
                  });
                  _push2(`<!--]-->`);
                }, _push2, _parent2, _scopeId);
                _push2(`</ul>`);
            ...
            if (unref(props).terms || !!slots.terms || (unref(props).button || !!slots.button) || unref(props).orientation === "horizontal" || (unref(props).tagline || !!slots.tagline) || !!slots.footer) {
              ...
              ssrRenderSlot(_ctx.$slots, "footer", {}, () => {
                if (unref(props).tagline || !!slots.tagline) {
                  _push2(`<div data-slot="tagline" class="${ssrRenderClass(ui.value.tagline({ class: unref(props).ui?.tagline }))}"${_scopeId}>`);
                  ssrRenderSlot(_ctx.$slots, "tagline", {}, () => {
                    _push2(`${ssrInterpolate(unref(props).tagline)}`);
                  }, _push2, _parent2, _scopeId);
                  _push2(`</div>`);
                } else {
                  _push2(`<!---->`);
                ...
                ssrRenderSlot(_ctx.$slots, "button", { ui: ui.value }, () => {
                  if (unref(props).button) {
                    _push2(ssrRenderComponent(_sfc_main$2, mergeProps({ block: true, size: "lg", ...unref(props).button }, {
                      "data-slot": "button",
                ...
                if (unref(props).terms || !!slots.terms) {
                  _push2(`<div data-slot="terms" class="${ssrRenderClass(ui.value.terms({ class: unref(props).ui?.terms }))}"${_scopeId}>`);
                  ssrRenderSlot(_ctx.$slots, "terms", {}, () => {
                    _push2(`${ssrInterpolate(unref(props).terms)}`);
                  }, _push2, _parent2, _scopeId);
                  _push2(`</div>`);
                } else {
                  _push2(`<!---->`);
                ...
                renderSlot(_ctx.$slots, "body", {}, () => [
                  createVNode("div", {
                    ...
                    renderSlot(_ctx.$slots, "badge", { ui: ui.value }, () => [
                      unref(props).badge ? (openBlock(), createBlock(_sfc_main$1, mergeProps({
                        key: 0,
                        color: "primary",
                        variant: "subtle"
                      }, typeof unref(props).badge === "string" ? { label: unref(props).badge } : unref(props).badge, {
                ...
                renderSlot(_ctx.$slots, "footer", {}, () => [
                  unref(props).tagline || !!slots.tagline ? (openBlock(), createBlock("div", {
                    ...
                    renderSlot(_ctx.$slots, "tagline", {}, () => [
                      createTextVNode(toDisplayString(unref(props).tagline), 1)
                    ])
                  ], 2)) : createCommentVNode("", true),
                  ...
                  renderSlot(_ctx.$slots, "button", { ui: ui.value }, () => [
                    unref(props).button ? (openBlock(), createBlock(_sfc_main$2, mergeProps({ key: 0 }, { block: true, size: "lg", ...unref(props).button }, {
                      "data-slot": "button",
                      class: ui.value.button({ class: unref(props).ui?.button }),
                      onClick: unref(props).button?.onClick
                  ...
                  unref(props).terms || !!slots.terms ? (openBlock(), createBlock("div", {
                    ...
                    renderSlot(_ctx.$slots, "terms", {}, () => [
                      createTextVNode(toDisplayString(unref(props).terms), 1)
                    ])
                  ], 2)) : createCommentVNode("", true)
                ])
              ], 2)) : createCommentVNode("", true)
