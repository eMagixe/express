...
import { defineComponent, ref, computed, reactive, shallowRef, watch, unref, withCtx, createVNode, mergeProps, withDirectives, openBlock, createBlock, isRef, createTextVNode, useId, inject, provide, readonly, resolveDynamicComponent, renderSlot, useSlots, toDisplayString, createCommentVNode, useModel, toRef, useTemplateRef, withModifiers, Fragment, renderList, mergeModels, toHandlers, getCurrentInstance, toRaw, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrGetDirectiveProps, ssrInterpolate, ssrRenderVNode, ssrRenderSlot, ssrRenderClass, ssrRenderAttr, ssrRenderList, ssrRenderAttrs } from 'vue/server-renderer';
import { useEventBus, reactivePick, createReusableTemplate, reactiveOmit } from '@vueuse/core';
import { b as _sfc_main$a, t as tv, i as formBusInjectionKey, j as formStateInjectionKey, k as formErrorsInjectionKey, l as formInputsInjectionKey, m as formLoadingInjectionKey, n as formOptionsInjectionKey, q as inputIdInjectionKey, r as formFieldInjectionKey, s as useFormField, u as useFieldGroup, c as useComponentIcons, v as isArrayOfArray, h as get, w as compare, a as _sfc_main$5$1, d as _sfc_main$3$1, x as _sfc_main$4$1, y as looseToNumber, z as getDisplayValue } from './Button-DmhYxLTA.mjs';
import { _ as _export_sfc, b as useAppConfig, d as useNuxtApp } from './server.mjs';
...
import { _ as _sfc_main$9, o as onPrehydrate } from './ssr-C3_WFKx-.mjs';
import { y as defu, B as isEqual } from '../nitro/nitro.mjs';
import { u as useLocale } from './useLocale-CqZyE3a8.mjs';
import { u as useToast, a as usePortal } from './useToast-yEiYMbdp.mjs';
                  ...
                  _push3(ssrRenderComponent(unref(CheckboxIndicator), {
                    ...
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        return [
                          modelValue2 === "indeterminate" ? (openBlock(), createBlock(_sfc_main$5$1, {
                            key: 0,
                            name: __props.indeterminateIcon || unref(appConfig).ui.icons.minus,
                            "data-slot": "icon",
                            class: ui.value.icon({ class: props.ui?.icon })
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(isOrderCreated)) {
        _push(`<div class="flex flex-col justify-center items-center text-sm" data-v-56da5397><p class="text-gray-200 text-center" data-v-56da5397> Заполните пожалуйста форму заказа, перед отправкой убедитесь что все данные введены верно </p><p class="text-primary text-center" data-v-56da5397> * Внимание при доставке до определенного адреса взымается дополнительная плата! </p></div>`);
      } else {
        _push(`<!---->`);
      }
      if (!unref(isOrderCreated)) {
        _push(ssrRenderComponent(_component_UForm, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex flex-col lg:grid lg:grid-cols-2 justify-start items-center lg:items-start gap-5" data-v-56da5397${_scopeId}>`);
              ...
              _push2(`<div class="date-time w-full flex not-sm:flex-col justify-start items-center gap-5" data-v-56da5397${_scopeId}>`);
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                if (unref(orderData).date) {
                                  ...
                                  _push5(`<p data-v-56da5397${_scopeId4}>Выберете дату</p>`);
                                }
                              } else {
                                return [
              ...
              _push2(`</div><div class="min-w-[320px] max-w-110 flex flex-col justify-center items-center" data-v-56da5397${_scopeId}>`);
              ...
              _push2(`</div></div><div class="w-full flex flex-row justify-center items-center pt-5 mb-20 gap-5" data-v-56da5397${_scopeId}>`);
        ...
        _push(`<div data-v-56da5397><div class="order-created w-full flex flex-col justify-start items-start mb-20 gap-5" data-v-56da5397><h3 class="text-2xl font-bold text-center" data-v-56da5397>Ваша заявка принята.</h3><p class="w-full text-center" data-v-56da5397>Спасибо, водитель свяжеться с вами.</p><p data-v-56da5397> Имя: <b data-v-56da5397>${ssrInterpolate(unref(orderData).name)}</b></p><p data-v-56da5397>Телефон: ${ssrInterpolate(unref(orderData).phone)}</p><p data-v-56da5397>Из: ${ssrInterpolate(unref(orderData).from)}, ${ssrInterpolate(unref(orderData).from_address)}</p><p data-v-56da5397>До: ${ssrInterpolate(unref(orderData).to)}, ${ssrInterpolate(unref(orderData).to_address)}</p><p data-v-56da5397>Дата: ${ssrInterpolate(unref(orderData).date)}, время: ${ssrInterpolate(unref(orderData).time)}</p></div></div>`);
      }
      _push(`<!--]-->`);
    };
  }
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-56da5397"]]), { __name: "OrderCreate" });
