...
import { u as useComponentProps, t as tv, P as Primitive, c as _sfc_main$1, p as pickLinkProps, d as _sfc_main$2, _ as _sfc_main$5, e as _sfc_main$3, f as get } from './Button-JdAC5Wqn.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(Primitive), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<ol data-slot="list" class="${ssrRenderClass(ui.value.list({ class: unref(props).ui?.list }))}"${_scopeId}><!--[-->`);
            ssrRenderList(unref(props).items, (item, index) => {
              _push2(`<!--[--><li data-slot="item" class="${ssrRenderClass(ui.value.item({ class: [unref(props).ui?.item, item.ui?.item] }))}"${_scopeId}>`);
                ...
                default: withCtx(({ active, ...slotProps }, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(_sfc_main$2, mergeProps({ ref_for: true }, slotProps, {
                      ...
                      "data-slot": "link",
                      class: ui.value.link({ class: [unref(props).ui?.link, item.ui?.link, item.class], active: item.active ?? index === unref(props).items.length - 1, disabled: !!item.disabled, to: !!item.to })
                    }), {
                            ...
                            ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
                              ...
                              if (item.icon) {
                                _push4(ssrRenderComponent(_sfc_main$5, {
                                  ...
                                  class: ui.value.linkLeadingIcon({ class: [unref(props).ui?.linkLeadingIcon, item.ui?.linkLeadingIcon], active: item.active ?? index === unref(props).items.length - 1 })
                                ...
                                _push4(ssrRenderComponent(_sfc_main$3, mergeProps({
                                  ...
                                  class: ui.value.linkLeadingAvatar({ class: [unref(props).ui?.linkLeadingAvatar, item.ui?.linkLeadingAvatar], active: item.active ?? index === unref(props).items.length - 1 })
                                }), null, _parent4, _scopeId3));
                              } else {
                                _push4(`<!---->`);
                              }
              ...
              if (index < unref(props).items.length - 1) {
                _push2(`<li role="presentation" aria-hidden="true" data-slot="separator" class="${ssrRenderClass(ui.value.separator({ class: [unref(props).ui?.separator, item.ui?.separator] }))}"${_scopeId}>`);
              ...
              createVNode("ol", {
                ...
                (openBlock(true), createBlock(Fragment, null, renderList(unref(props).items, (item, index) => {
                  return openBlock(), createBlock(Fragment, { key: index }, [
                    ...
                    index < unref(props).items.length - 1 ? (openBlock(), createBlock("li", {
                      key: 0,
                      role: "presentation",
                      "aria-hidden": "true",
                      "data-slot": "separator",
