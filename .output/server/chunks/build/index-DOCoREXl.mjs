...
const __nuxt_component_3_lazy_visible = createLazyVisibleComponent("components/section/advantages.vue", () => import('./advantages-D0zV42cr.mjs').then((c) => c.default || c));
const __nuxt_component_4_lazy = defineAsyncComponent(() => import('./reviews-nJ29_ExO.mjs').then((c) => c.default || c));
const __nuxt_component_5_lazy_visible = createLazyVisibleComponent("components/section/questions.vue", () => import('./questions-C3sKPrhz.mjs').then((c) => c.default || c));
const __nuxt_component_6_lazy_visible = createLazyVisibleComponent("components/section/order.vue", () => import('./order-Bt2Eexhe.mjs').then((c) => c.default || c));
const __nuxt_component_7_lazy_visible = createLazyVisibleComponent("components/section/footer.vue", () => import('./footer-CfW4BJ_8.mjs').then((c) => c.default || c));
...
//# sourceMappingURL=index-DOCoREXl.mjs.map
