import { defineComponent, withCtx, unref, createVNode, createTextVNode, toDisplayString, defineAsyncComponent, toRef, provide, mergeProps, useId, renderSlot, openBlock, createBlock, computed, resolveDynamicComponent, useSlots, useModel, watch, createCommentVNode, mergeModels, ref, Fragment, renderList, toRefs, useTemplateRef, withModifiers, normalizeProps, guardReactiveProps, watchEffect, normalizeStyle, shallowReactive, reactive, markRaw, createElementBlock, Teleport, nextTick, onScopeDispose, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrInterpolate, ssrRenderSlot, ssrRenderAttrs, ssrRenderList, ssrRenderVNode, ssrRenderClass, ssrRenderAttr, ssrRenderStyle } from 'vue/server-renderer';
import { p as portalTargetInjectionKey, C as ConfigProvider_default, a as usePortal, T as Teleport_default, f as focusFirst$1, P as Presence_default, g as getActiveElement, V as VisuallyHidden_default, b as getTabbableCandidates, i as isNullish } from './overlay-BwRuhiSQ.mjs';
import { _ as _sfc_main$5$1, k as useForwardProps$1, u as useComponentProps, g as getSlotChildrenText, t as tv, b as _sfc_main$f, c as _sfc_main$1$1, P as Primitive, a as useForwardProps, o as omit, e as _sfc_main$3$1, j as createContext } from './Button-JdAC5Wqn.mjs';
import { T as TooltipProvider_default, _ as _sfc_main$e } from './Slideover-Cp3CogCn.mjs';
...
import { g as __nuxt_component_5, _ as _export_sfc, e as useRoute, b as useAppConfig } from './server.mjs';
import { _ as _sfc_main$b } from './Modal-C-ve2RJr.mjs';
import { _ as __nuxt_component_0$2 } from './nuxt-link-CJMHb7no.mjs';
import { _ as _sfc_main$c } from './Container-BzK8dUVM.mjs';
import { z as defu, p as publicAssetsURL } from '../nitro/nitro.mjs';
import { _ as _sfc_main$d } from './Drawer-CDheLM8H.mjs';
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$2]]), { __name: "Menu" });
const _sfc_main$2 = {};
...
const __nuxt_component_4$1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$1]]), { __name: "Phones" });
const _sfc_main$1 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_Phones = __nuxt_component_4$1;
...
const __nuxt_component_4 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender]]), { __name: "SectionHeader" });
const __nuxt_component_6_lazy = defineAsyncComponent(() => import('./footer-DPfCA2KY.mjs').then((c) => c.default || c));
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0$2;
      const _component_UIcon = _sfc_main$5$1;
      const _component_SectionHeader = __nuxt_component_4;
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UModal, {
              ...
              body: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h2 class="text-primary text-2xl"${_scopeId2}>Ваш номер заявки: #${ssrInterpolate(unref(call).order.value.uid)}</h2><p class="text-sm text-white"${_scopeId2}>Назовите его диспетчеру при необходимости...</p>`);
