import { _ as _sfc_main$2 } from './Container-BxaGJmMa.mjs';
import { _ as _sfc_main$3 } from './PricingPlan-vxO4YvF_.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-BVaogQjF.mjs';
...
import { u as useLazyFetch } from './fetch-BcNBoCK9.mjs';
...
const __nuxt_component_1_lazy = defineAsyncComponent(() => import('./advantages-COOKXIog.mjs').then((c) => c.default || c));
const __nuxt_component_2_lazy = defineAsyncComponent(() => import('./reviews-CirtHoJh.mjs').then((c) => c.default || c));
const __nuxt_component_3_lazy = defineAsyncComponent(() => import('./questions-B2xXlJAj.mjs').then((c) => c.default || c));
const __nuxt_component_4_lazy = defineAsyncComponent(() => import('./order-Ccs3a83H.mjs').then((c) => c.default || c));
