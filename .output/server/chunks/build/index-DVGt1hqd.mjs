...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "welcome-section w-full mx-auto mb-10" }, _attrs))} data-v-336e98f4>`);
      _push(ssrRenderComponent(_component_UContainer, { class: "h-[calc(100vh-100px)] min-h-160 flex flex-col justify-start gap-5 pt-10" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="cities-list w-full flex flex-row justify-center items-center gap-10" data-v-336e98f4${_scopeId}><!--[-->`);
            ...
            _push2(`<!--]--></div><div class="flex flex-col md:flex-row justify-between items-center gap-2 py-2 px-3 rounded-lg bg-gradient-to-r from-gray-600/30 to-gray-700/30 backdrop-blur-[5px] mx-5" data-v-336e98f4${_scopeId}><p class="text-sm text-white" data-v-336e98f4${_scopeId}>* требуется дополнительная оплата</p>`);
            ...
            _push2(`</div><h2 class="font-medium text-[clamp(1.25rem,3vw,3rem)] text-white text-center lg:text-left w-full lg:w-[70%]" data-v-336e98f4${_scopeId}> Круглосуточные перевозки </h2>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
            ...
            _push2(`<div class="not-sm:hidden text-[clamp(1rem,3vw,2rem)] border-t-3 border-t-primary/20 pt-10 text-white text-center lg:text-left w-full lg:w-[60%]" data-v-336e98f4${_scopeId}> Быстро и с комфортом доставим вас в нужное место в любое время дня и ночи </div>`);
          } else {
            return [
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["__scopeId", "data-v-336e98f4"]]), { __name: "SectionWelcome" });
