import { computed, useId, useTemplateRef, inject, provide, ref, reactive, readonly, createVNode, resolveDynamicComponent, unref, mergeProps, withCtx, renderSlot, useSlots, watch, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, defineComponent, useSSRContext } from 'vue';
...
import { u as useComponentProps, t as tv, v as formBusInjectionKey, w as formStateInjectionKey, x as formErrorsInjectionKey, y as formInputsInjectionKey, z as formLoadingInjectionKey, A as formOptionsInjectionKey, B as inputIdInjectionKey, C as formFieldInjectionKey, P as Primitive } from './Button-0rygPcVD.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const ui = computed(() => tv({ extend: theme$1, ...appConfig.ui?.form || {} }));
