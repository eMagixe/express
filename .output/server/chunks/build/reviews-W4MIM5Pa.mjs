      ...
      _push(ssrRenderComponent(_component_UContainer, { class: "flex flex-col justify-center items-center gap-5" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(reviewsViews).length > 0) {
              _push2(`<!--[-->`);
              ...
              body: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (unref(reviews2).length > 0) {
                    ...
                    _push3(`<p class="text-primary w-full text-center"${_scopeId2}>Отзывов пока нет</p>`);
                  }
                  _push3(`</div>`);
                } else {
                  return [
                    createVNode("div", { class: "modal-reviews" }, [
                      unref(reviews2).length > 0 ? (openBlock(), createBlock(_component_UMarquee, {
                        ...
                        key: 1,
                        class: "text-primary w-full text-center"
                      }, "Отзывов пока нет"))
                    ])
                  ];
                }
            ...
            return [
              ...
              createVNode("div", { class: "w-full flex flex-col justify-start items-center pt-10 gap-10" }, [
                unref(reviewsViews).length > 0 ? (openBlock(true), createBlock(Fragment, { key: 0 }, renderList(unref(reviewsViews), (item, index) => {
                  return openBlock(), createBlock("div", {
                    key: index,
