import { h as useNuxtApp, j as appDiagnostics, k as asyncDataDefaults, l as prodReporters, m as docsBase, o as createError$1, q as sanitizeTag } from '../virtual/entry.mjs';
import { defineProdDiagnostics } from 'nostics';
import { unref, isRef, computed, toValue, getCurrentInstance, onServerPrefetch, ref, shallowRef, nextTick, toRef, queuePostFlushCb, defineComponent, provide, cloneVNode, h, createElementBlock } from 'vue';
...
export { dataDiagnostics as a, clearNuxtData as c, defineKeyedFunctionFactory as d, useAsyncData as u };
