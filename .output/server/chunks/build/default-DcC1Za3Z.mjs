import { withCtx, createVNode, defineAsyncComponent, toRef, provide, unref, mergeProps, useId, renderSlot, openBlock, createBlock, defineComponent, createTextVNode, toDisplayString, computed, resolveDynamicComponent, useSlots, createCommentVNode, Fragment, renderList, useModel, watch, mergeModels, ref, nextTick, toRefs, useTemplateRef, withModifiers, normalizeProps, guardReactiveProps, watchEffect, normalizeStyle, shallowReactive, reactive, markRaw, createElementBlock, Teleport, onScopeDispose, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderStyle, ssrRenderSlot, ssrInterpolate, ssrRenderAttrs, ssrRenderList, ssrRenderVNode, ssrRenderClass, ssrRenderAttr } from 'vue/server-renderer';
import { p as portalTargetInjectionKey, C as ConfigProvider_default, a as usePortal, i as isNullish, T as Teleport_default, f as focusFirst$1, P as Presence_default, g as getActiveElement, V as VisuallyHidden_default, b as getTabbableCandidates } from './overlay-Svs1-PRJ.mjs';
import { n as useForwardProps$1, _ as _sfc_main$5$1, u as useComponentProps, c as useForwardProps, t as tv, P as Primitive, g as getSlotChildrenText, b as _sfc_main$g, a as _sfc_main$1$1, o as omit, f as _sfc_main$3$1, m as createContext } from './Button-NFuoQ1v4.mjs';
import { T as TooltipProvider_default, _ as _sfc_main$f } from './Slideover-ByQ3TwX_.mjs';
import { reactivePick, createReusableTemplate, createSharedComposable, useVModel, onKeyStroke, unrefElement, useRafFn } from '@vueuse/core';
import { l as localeContextInjectionKey, u as useLocale } from './useLocale-BsE26tc8.mjs';
import { u as useCollection } from './Collection-xD_b4Pjw.mjs';
import { u as useForwardExpose } from './useForwardExpose-C3mVDiKg.mjs';
import { u as useToast, t as toastMaxInjectionKey } from './useToast-YcMWm34g.mjs';
import { isClient, useTimeout } from '@vueuse/shared';
import { _ as _export_sfc, g as __nuxt_component_3$1, b as useAppConfig, a as useRoute } from './server.mjs';
import { _ as _sfc_main$c } from './Modal-BNNalsv1.mjs';
import { _ as __nuxt_component_0$2 } from './nuxt-link-DDci5Ary.mjs';
import { u as useCall } from './useCall-bD_P2z8n.mjs';
import { _ as _sfc_main$d } from './Container-zod5AUW4.mjs';
        ...
        default: withCtx(({ remaining, duration: totalDuration, open }, _push2, _parent2, _scopeId) => {
          if (_push2) {
                    ...
                    if (_push3) {
                      ...
                      return [
                        renderSlot(_ctx.$slots, "close", { ui: ui.value }, () => [
                          unref(props).close ? (openBlock(), createBlock(_sfc_main$g, mergeProps({
                            key: 0,
                            icon: unref(props).closeIcon || unref(appConfig).ui.icons.close,
                            color: "neutral",
                            variant: "link",
            ...
            return [
              ...
              unref(props).progress && open && remaining > 0 && totalDuration ? (openBlock(), createBlock(_sfc_main$b, mergeProps({
                key: 1,
                "model-value": remaining / totalDuration * 100,
                color: unref(props).color
              }, typeof unref(props).progress === "object" ? unref(props).progress : {}, {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UModal, mergeProps({
        ...
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="text-primary text-2xl"${_scopeId}>Ваш номер заявки: #${ssrInterpolate(unref(call).order.value.uid)}</h2><p class="text-sm text-white"${_scopeId}>Назовите его диспетчеру при необходимости...</p>`);
            if (unref(call).order.value.callEnabled) {
              ...
              _push2(ssrRenderComponent(_component_UProgress, null, null, _parent2, _scopeId));
            }
          } else {
            return [
              createVNode("h2", { class: "text-primary text-2xl" }, "Ваш номер заявки: #" + toDisplayString(unref(call).order.value.uid), 1),
              createVNode("p", { class: "text-sm text-white" }, "Назовите его диспетчеру при необходимости..."),
...
const __nuxt_component_1 = Object.assign(_sfc_main$6, { __name: "ModalCall" });
const theme = {
  "slots": {
          ...
          if (_push2) {
            ...
            return [
              renderSlot(_ctx.$slots, "toggle", {
                ...
                unref(props).toggle ? (openBlock(), createBlock(_sfc_main$g, mergeProps({
                  key: 0,
                  color: "neutral",
                  variant: "ghost",
                  "aria-label": open.value ? unref(t)("header.close") : unref(t)("header.open"),
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender$4]]), { __name: "Logo" });
const _sfc_main$3 = {};
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3]]), { __name: "Menu" });
const _sfc_main$2 = {};
...
const __nuxt_component_4 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2]]), { __name: "Phones" });
const _sfc_main$1 = {};
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  const _component_UContainer = _sfc_main$d;
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1]]), { __name: "SectionHeader" });
const __nuxt_component_4_lazy = defineAsyncComponent(() => import('./footer-DBmPFH2e.mjs').then((c) => c.default || c));
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_UApp = __nuxt_component_0$1;
  const _component_ModalCall = __nuxt_component_1;
  const _component_SectionHeader = __nuxt_component_2;
  ...
  _push(ssrRenderComponent(_component_UApp, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_ModalCall, null, null, _parent2, _scopeId));
        ...
        _push2(`<noscript${_scopeId}><div${_scopeId}><img src="https://mc.yandex.ru/watch/111727262" style="${ssrRenderStyle({ "position": "absolute", "left": "-9999px" })}" alt=""${_scopeId}></div></noscript>`);
      } else {
        return [
          ...
          createVNode("noscript", null, [
            createVNode("div", null, [
              createVNode("img", {
                src: "https://mc.yandex.ru/watch/111727262",
...
export { __nuxt_component_0 as _, _default$1 as a };
