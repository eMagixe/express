...
import { D as DropdownMenuRoot_default, g as DropdownMenuTrigger_default, h as DropdownMenuArrow_default, i as useFilter, u as useForwardPropsEmits, j as DropdownMenu } from './useFilter-BYxl4qgK.mjs';
import { reactivePick, reactiveOmit, createReusableTemplate, createSharedComposable } from '@vueuse/core';
import { u as useComponentProps, a as useForwardProps, t as tv, i as isArrayOfArray, _ as _sfc_main$5, e as _sfc_main$3, f as get, F as FieldGroupReset, c as _sfc_main$1$1, p as pickLinkProps, d as _sfc_main$2$1, o as omit, P as Primitive } from './Button-JdAC5Wqn.mjs';
import { u as useLocale } from './useLocale-DsziUxw1.mjs';
import { a as usePortal } from './overlay-BwRuhiSQ.mjs';
import { _ as _sfc_main$4 } from './Input-eAMQh3dc.mjs';
              ...
              renderSlot(_ctx.$slots, item.slot || "item", {
                ...
                unref(get)(item, props.labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"] || (unref(get)(item, props.descriptionKey) || !!slots[item.slot ? `${item.slot}-description` : "item-description"]) ? (openBlock(), createBlock("span", {
                  ...
                  createVNode("span", {
                    ...
                    item.target === "_blank" && __props.externalIcon !== false ? (openBlock(), createBlock(_sfc_main$5, {
                      key: 0,
                      name: typeof __props.externalIcon === "string" ? __props.externalIcon : unref(appConfig).ui.icons.external,
                      "data-slot": "itemLabelExternalIcon",
                      class: __props.ui.itemLabelExternalIcon({ class: [__props.uiOverride?.itemLabelExternalIcon, item.ui?.itemLabelExternalIcon], color: item?.color, active })
                                ...
                                if (_push5) {
                                  ...
                                  ssrRenderList(group, (item, index) => {
                                    ...
                                    if (item.type === "label") {
                                      ...
                                      _push5(ssrRenderComponent(_sfc_main$1$1, mergeProps({ ref_for: true }, unref(pickLinkProps)(item), { custom: "" }), {
                                          ...
                                          if (_push6) {
                                            _push6(ssrRenderComponent(unref(DropdownMenu).Item, {
                                              ...
                                              default: withCtx((_5, _push7, _parent7, _scopeId6) => {
                                                if (_push7) {
                                                  _push7(ssrRenderComponent(_sfc_main$2$1, mergeProps({ ref_for: true }, slotProps, {
                                                    "data-slot": "item",
                                                  ...
                                                  return [
                                                    createVNode(_sfc_main$2$1, mergeProps({ ref_for: true }, slotProps, {
                                                      "data-slot": "item",
                                                      class: __props.ui.item({ class: [__props.uiOverride?.item, item.ui?.item, item.class], color: item?.color, active })
                                                    }), {
                                                      default: withCtx(() => [
                                    ...
                                    (openBlock(true), createBlock(Fragment, null, renderList(group, (item, index) => {
                                      return openBlock(), createBlock(Fragment, {
                                        ...
                                        item.type === "label" ? (openBlock(), createBlock(unref(DropdownMenu).Label, {
                                          ...
                                          _: 2
                                        }, 1032, ["model-value", "disabled", "text-value", "class", "onUpdate:modelValue", "onSelect"])) : (openBlock(), createBlock(_sfc_main$1$1, mergeProps({
                                          key: 4,
                                          ref_for: true
