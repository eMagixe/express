...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "section-advantages w-full mx-auto h-auto pt-5 pb-10 border-b border-b-primary/70" }, _attrs))} data-v-a352e67f>`);
      _push(ssrRenderComponent(_component_UContainer, { class: "flex flex-col justify-start items-center gap-5" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="lg:w-[70%] flex flex-col justify-center items-center gap-5" data-v-a352e67f${_scopeId}><!--[-->`);
            ssrRenderList(advantages2, (item, index) => {
              _push2(`<!--[--><div class="item animation-box flex flex-row justify-center items-center gap-5 w-full" data-v-a352e67f${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UIcon, {
                class: "text-white min-w-9 min-h-9 text-[4cqw]",
                name: item.icon
              }, null, _parent2, _scopeId));
              _push2(`<div data-v-a352e67f${_scopeId}><div class="flex flex-row justify-start items-center gap-2 text-white" data-v-a352e67f${_scopeId}><!--[-->`);
              ssrRenderList(item.message, (i) => {
                _push2(`<span class="${ssrRenderClass(`uppercase sm:text-[16px] md:text-[24px] lg:text-[40px] text-[${i.color}]`)}" data-v-a352e67f${_scopeId}>${ssrInterpolate(i.text)}</span>`);
              });
              _push2(`<!--]--></div><div class="text-white sm:text-[10px] md:text-[14px] lg:text-[20px] text-left uppercase" data-v-a352e67f${_scopeId}>${ssrInterpolate(item.description)}</div></div></div>`);
              if (!item.lost) {
                _push2(ssrRenderComponent(_component_UIcon, {
...
const advantages = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-a352e67f"]]), { __name: "SectionAdvantages" });
