...
import { p as portalTargetInjectionKey, C as ConfigProvider_default, a as usePortal, i as isNullish, T as Teleport_default, f as focusFirst$1, P as Presence_default, g as getActiveElement, V as VisuallyHidden_default, b as getTabbableCandidates } from './overlay-C1FnIn7k.mjs';
import { n as useForwardProps$1, _ as _sfc_main$5$1, u as useComponentProps, c as useForwardProps, t as tv, P as Primitive, g as getSlotChildrenText, b as _sfc_main$g, a as _sfc_main$1$1, o as omit, f as _sfc_main$3$1, m as createContext } from './Button-0rygPcVD.mjs';
import { T as TooltipProvider_default, _ as _sfc_main$f } from './Slideover-MWfssoba.mjs';
...
import { l as localeContextInjectionKey, u as useLocale } from './useLocale-B5JGR0nR.mjs';
import { u as useCollection } from './Collection-BzcpTT2F.mjs';
...
import { _ as _sfc_main$c } from './Modal-DyY1oH2O.mjs';
import { _ as __nuxt_component_0$2 } from './nuxt-link-DDci5Ary.mjs';
import { u as useCall } from './useCall-bD_P2z8n.mjs';
import { _ as _sfc_main$d } from './Container-02OulfH9.mjs';
import { B as defu, p as publicAssetsURL } from '../nitro/nitro.mjs';
import { _ as _sfc_main$e } from './Drawer-CXsEhZw-.mjs';
import 'aria-hidden';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UModal, mergeProps({
        ...
        body: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="text-primary text-2xl text-center w-full"${_scopeId}>Ваш номер заявки: #${ssrInterpolate(unref(call).order.value.uid)}</h2><p class="text-sm text-white text-center w-full"${_scopeId}>Назовите его диспетчеру при необходимости...</p>`);
...
const __nuxt_component_4_lazy = defineAsyncComponent(() => import('./footer-C2l1jpdq.mjs').then((c) => c.default || c));
const _sfc_main = {};
