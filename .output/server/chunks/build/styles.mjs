...
const styles = {
  ...
  "components/section/reviews.vue": () => import('./reviews-styles.DMqhbbf6.mjs').then(interopDefault),
  "layouts/empty.vue": () => import('./empty-styles.CvwvE9Cl.mjs').then(interopDefault),
  ...
  "layouts/empty.vue?vue&type=style&index=0&scoped=64d9c598&lang.css": () => import('./empty-styles.CvwvE9Cl.mjs').then(interopDefault),
  "components/section/welcome.vue": () => import('./welcome-styles.DxqQfCA5.mjs').then(interopDefault),
  "components/order/create.vue": () => import('./create-styles.dXxvZLqb.mjs').then(interopDefault),
  "components/section/advantages.vue": () => import('./advantages-styles.DNxnKZ52.mjs').then(interopDefault),
  "components/section/order.vue": () => import('./order-styles.-6m_3pTh.mjs').then(interopDefault),
  "components/section/questions.vue": () => import('./questions-styles.CMB5Jjns.mjs').then(interopDefault),
  "components/section/welcome.vue?vue&type=style&index=0&scoped=9bce0c03&lang.css": () => import('./welcome-styles.DxqQfCA5.mjs').then(interopDefault),
  "components/order/create.vue?vue&type=style&index=0&scoped=502ed42b&lang.css": () => import('./create-styles.dXxvZLqb.mjs').then(interopDefault),
  ...
  "components/section/order.vue?vue&type=style&index=0&scoped=0ab721c1&lang.css": () => import('./order-styles.-6m_3pTh.mjs').then(interopDefault),
  "components/section/questions.vue?vue&type=style&index=0&scoped=28f06034&lang.css": () => import('./questions-styles.CMB5Jjns.mjs').then(interopDefault),
