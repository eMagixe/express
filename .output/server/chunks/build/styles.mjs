...
const styles = {
  ...
  "components/section/welcome.vue": () => import('./welcome-styles.DIKt0t1a.mjs').then(interopDefault),
  ...
  "components/order/create.vue": () => import('./create-styles.7FOBF1qW.mjs').then(interopDefault),
  "components/order/create.vue?vue&type=style&index=0&scoped=7ed6d4b3&lang.css": () => import('./create-styles.7FOBF1qW.mjs').then(interopDefault)
};
