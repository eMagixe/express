...
const styles = {
  ...
  "components/preview/viewer.vue": () => import('./viewer-styles.DIJImG3b.mjs').then(interopDefault),
  "components/preview/all.vue": () => import('./all-styles.BT9hSVlP.mjs').then(interopDefault),
  "components/order/create.vue": () => import('./create-styles.Ddpb2AWP.mjs').then(interopDefault),
  "components/preview/viewer.vue?vue&type=style&index=0&scoped=316fe5cc&lang.css": () => import('./viewer-styles.DIJImG3b.mjs').then(interopDefault),
  "components/preview/all.vue?vue&type=style&index=0&scoped=fe4605e8&lang.css": () => import('./all-styles.BT9hSVlP.mjs').then(interopDefault),
