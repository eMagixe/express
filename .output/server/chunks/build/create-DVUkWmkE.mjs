...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(isOrderCreated)) {
        _push(`<div class="flex flex-col justify-center items-center text-sm" data-v-b1a9a309><p class="text-gray-200 text-center" data-v-b1a9a309> Заполните пожалуйста форму заказа, перед отправкой убедитесь что все данные введены верно </p><p class="text-primary text-center" data-v-b1a9a309> * Внимание при доставке до определенного адреса взымается дополнительная плата! </p></div>`);
      } else {
        _push(`<!---->`);
      }
      if (!unref(isOrderCreated)) {
        _push(ssrRenderComponent(_component_UForm, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="flex flex-col lg:grid lg:grid-cols-2 justify-start items-center lg:items-start gap-5" data-v-b1a9a309${_scopeId}>`);
              ...
              _push2(`<div class="date-time w-full flex not-sm:flex-col justify-start items-center gap-5" data-v-b1a9a309${_scopeId}>`);
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                if (unref(orderData).date) {
                                  ...
                                  _push5(`<p data-v-b1a9a309${_scopeId4}>Выберете дату</p>`);
                                }
                              } else {
                                return [
              ...
              _push2(`</div><div class="min-w-[320px] max-w-110 flex flex-col justify-center items-center" data-v-b1a9a309${_scopeId}>`);
              ...
              _push2(`</div></div><div class="w-full flex flex-row justify-center items-center pt-5 mb-20 gap-5" data-v-b1a9a309${_scopeId}>`);
        ...
        _push(`<div data-v-b1a9a309><div class="order-created w-full flex flex-col justify-start items-start mb-20 gap-5" data-v-b1a9a309><h3 class="text-2xl font-bold text-center" data-v-b1a9a309>Ваша заявка принята.</h3><p class="w-full text-center" data-v-b1a9a309>Спасибо, водитель свяжеться с вами.</p><p data-v-b1a9a309> Имя: <b data-v-b1a9a309>${ssrInterpolate(unref(orderData).name)}</b></p><p data-v-b1a9a309>Телефон: ${ssrInterpolate(unref(orderData).phone)}</p><p data-v-b1a9a309>Из: ${ssrInterpolate(unref(orderData).from)}, ${ssrInterpolate(unref(orderData).from_address)}</p><p data-v-b1a9a309>До: ${ssrInterpolate(unref(orderData).to)}, ${ssrInterpolate(unref(orderData).to_address)}</p><p data-v-b1a9a309>Дата: ${ssrInterpolate(unref(orderData).date)}, время: ${ssrInterpolate(unref(orderData).time)}</p></div></div>`);
      }
      _push(`<!--]-->`);
    };
  }
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-b1a9a309"]]), { __name: "OrderCreate" });
