...
const __nuxt_component_3_lazy = defineAsyncComponent(() => import('./questions-D9J8GDLo.mjs').then((c) => c.default || c));
const __nuxt_component_4_lazy = defineAsyncComponent(() => import('./order-BLQSsU-f.mjs').then((c) => c.default || c));
