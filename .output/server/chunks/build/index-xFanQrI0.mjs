...
const __nuxt_component_3_lazy_visible = createLazyVisibleComponent("components/section/advantages.vue", () => import('./advantages-BRrUKVU9.mjs').then((c) => c.default || c));
const __nuxt_component_4_lazy_visible = createLazyVisibleComponent("components/section/reviews.vue", () => import('./reviews-Bp_AUn4h.mjs').then((c) => c.default || c));
const __nuxt_component_5_lazy_visible = createLazyVisibleComponent("components/section/questions.vue", () => import('./questions-2VlL9sgr.mjs').then((c) => c.default || c));
const __nuxt_component_6_lazy_visible = createLazyVisibleComponent("components/section/order.vue", () => import('./order-BzwwGJrJ.mjs').then((c) => c.default || c));
const __nuxt_component_7_lazy_visible = createLazyVisibleComponent("components/section/footer.vue", () => import('./footer-BQGkG9Zi.mjs').then((c) => c.default || c));
...
//# sourceMappingURL=index-xFanQrI0.mjs.map
