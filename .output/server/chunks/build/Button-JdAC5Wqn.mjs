...
import NuxtIcon from './index-zQtgCi6v.mjs';
...
const _sfc_main$4 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const appConfig2 = useAppConfig();
    const ui = computed(() => tv({ extend: theme$3, ...appConfig2.ui?.chip || {} })({
      color: props.color,
...
const _sfc_main$3 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    const ui = computed(() => tv({ extend: theme$2, ...appConfig2.ui?.avatar || {} })({
      size: size.value ?? props.size,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(props).chip ? _sfc_main$4 : unref(Primitive)), mergeProps({
        as: as.value.root
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx(({ active, ...slotProps }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$2, mergeProps({ "data-slot": "base" }, slotProps, {
              class: ui.value.base({
            ...
            return [
              createVNode(_sfc_main$2, mergeProps({ "data-slot": "base" }, slotProps, {
                class: ui.value.base({
                  class: [unref(props).ui?.base, unref(props).class],
                  active,
                  ...active && unref(props).activeVariant ? { variant: unref(props).activeVariant } : {},
...
export { useFormField as A, looseToNumber as B, renderSlotFragments as C, compare as D, getDisplayValue as E, FieldGroupReset as F, Primitive as P, Slot as S, _sfc_main$5 as _, useForwardProps as a, _sfc_main as b, _sfc_main$1 as c, _sfc_main$2 as d, _sfc_main$3 as e, get as f, getSlotChildrenText as g, _sfc_main$4 as h, isArrayOfArray as i, createContext as j, useForwardProps$1 as k, useFieldGroup as l, useComponentIcons as m, useEmitAsProps as n, omit as o, pickLinkProps as p, formBusInjectionKey as q, formStateInjectionKey as r, formErrorsInjectionKey as s, tv as t, useComponentProps as u, formInputsInjectionKey as v, formLoadingInjectionKey as w, formOptionsInjectionKey as x, inputIdInjectionKey as y, formFieldInjectionKey as z };
