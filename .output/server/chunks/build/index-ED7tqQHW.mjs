...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "welcome-section w-full mx-auto mb-10" }, _attrs))} data-v-d4b2d0bf>`);
  _push(ssrRenderComponent(_component_UContainer, { class: "h-[calc(100vh-100px)] min-h-160 flex flex-col justify-start gap-5 pt-10" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="cities-list w-full flex flex-row justify-center items-center gap-10" data-v-d4b2d0bf${_scopeId}>`);
        ...
        _push2(`</div><p class="text-sm text-center text-gray-400" data-v-d4b2d0bf${_scopeId}>* требуется дополнительная оплата</p><h2 class="font-medium text-[clamp(1.25rem,3vw,3rem)] text-white text-center lg:text-left w-full lg:w-[70%]" data-v-d4b2d0bf${_scopeId}> Круглосуточные перевозки </h2>`);
        ...
        _push2(`<div class="not-sm:hidden text-[clamp(1rem,3vw,2rem)] border-t-3 border-t-primary/20 pt-10 text-white text-center lg:text-left w-full lg:w-[60%]" data-v-d4b2d0bf${_scopeId}> Быстро и с комфортом доставим вас в нужное место в любое время дня и ночи </div>`);
      } else {
        return [
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-d4b2d0bf"]]), { __name: "SectionWelcome" });
