import { _ as _sfc_main$c } from './Container-CV6NPFlX.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-DDci5Ary.mjs';
import { _ as _sfc_main$5$1, u as useComponentProps, t as tv, P as Primitive, g as getSlotChildrenText, a as _sfc_main$1$1, b as _sfc_main$f, c as useForwardProps, d as useFormField, e as useComponentIcons, f as _sfc_main$3$1, l as looseToNumber } from './Button-Toj_U7zK.mjs';
import { _ as _sfc_main$d } from './PricingPlan-CqsAcnmk.mjs';
import { u as useCall } from './useCall-bD_P2z8n.mjs';
import { defineComponent, defineAsyncComponent, ref, withAsyncContext, mergeProps, withCtx, unref, createVNode, createTextVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, createCommentVNode, useId, computed, renderSlot, useSlots, watch, useTemplateRef, nextTick, useSSRContext } from 'vue';
...
import { _ as _sfc_main$g } from './Modal-CbdYAkBJ.mjs';
import { _ as _sfc_main$h } from './Input-Bee2SyLB.mjs';
...
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "welcome-section w-full mx-auto mb-10" }, _attrs))} data-v-39c0467c>`);
      _push(ssrRenderComponent(_component_UContainer, { class: "h-[calc(100vh-100px)] min-h-160 flex flex-col justify-start gap-5 pt-10" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 class="font-medium text-[clamp(1.5rem,2.5vw,3rem)] text-white text-center w-full" data-v-39c0467c${_scopeId}> Такси межгород Кумертау — Уфа </h1>`);
            ...
            _push2(`<div class="cities-list w-full flex flex-row justify-center items-center gap-10" data-v-39c0467c${_scopeId}><!--[-->`);
            ...
            _push2(`<!--]--></div><div class="flex flex-col md:flex-row justify-between items-center gap-2 py-2 px-3 rounded-lg bg-gradient-to-r from-gray-600/30 to-gray-700/30 backdrop-blur-[5px] mx-5" data-v-39c0467c${_scopeId}><p class="text-sm text-white" data-v-39c0467c${_scopeId}>* требуется дополнительная оплата</p>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_UIcon, { name: "i-lucide-split" }, null, _parent3, _scopeId2));
                  _push3(` Основные направления`);
                } else {
                  return [
                    createVNode(_component_UIcon, { name: "i-lucide-split" }),
                    createTextVNode(" Основные направления")
                  ];
                }
              }),
              _: 1
            }, _parent2, _scopeId));
            _push2(`</div><div class="not-sm:hidden text-[clamp(1rem,3vw,2rem)] pt-10 mx-auto text-white text-center w-2/3" data-v-39c0467c${_scopeId}> Быстро и с комфортом доставим вас в нужное место в любое время дня и ночи </div>`);
          } else {
            return [
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$b, [["__scopeId", "data-v-39c0467c"]]), { __name: "SectionWelcome" });
...
const __nuxt_component_4_lazy = defineAsyncComponent(() => import('./order-uOUkLp_q.mjs').then((c) => c.default || c));
