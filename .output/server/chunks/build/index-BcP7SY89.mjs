import { _ as _sfc_main$c } from './Container-02OulfH9.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-DDci5Ary.mjs';
import { _ as _sfc_main$5$1, u as useComponentProps, t as tv, P as Primitive, g as getSlotChildrenText, a as _sfc_main$1$1, b as _sfc_main$f, c as useForwardProps, d as useFormField, e as useComponentIcons, f as _sfc_main$3$1, l as looseToNumber } from './Button-0rygPcVD.mjs';
import { _ as _sfc_main$d } from './PricingPlan-Bg7ak_fm.mjs';
...
import { u as useFetch } from './fetch-Cprs8gzJ.mjs';
...
import { _ as _sfc_main$g } from './Modal-DyY1oH2O.mjs';
import { _ as _sfc_main$h } from './Input-BPWloM4R.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UContainer, { class: "h-[calc(100vh-100px)] min-h-160 flex flex-col justify-start gap-5 pt-10" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 class="font-medium text-[clamp(1.5rem,2.5vw,3rem)] text-white text-center w-full" data-v-9bce0c03${_scopeId}> Такси межгород Кумертау — Уфа </h1>`);
            ...
            _push2(`<div class="cities-list w-full flex flex-row justify-center items-center gap-10" data-v-9bce0c03${_scopeId}><!--[-->`);
            ...
            _push2(`<!--]--></div><div class="flex flex-col md:flex-row justify-between items-center gap-2 py-2 px-3 rounded-lg bg-gradient-to-r from-gray-600/30 to-gray-700/30 backdrop-blur-[5px] mx-5" data-v-9bce0c03${_scopeId}><p class="text-sm text-white" data-v-9bce0c03${_scopeId}>* требуется дополнительная оплата</p>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
            ...
            _push2(`</div><div class="not-sm:hidden text-[clamp(1rem,3vw,2rem)] pt-10 mx-auto text-white text-center w-2/3" data-v-9bce0c03${_scopeId}> Быстро и с комфортом доставим вас в нужное место в любое время дня и ночи </div>`);
          } else {
            return [
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$b, [["__scopeId", "data-v-9bce0c03"]]), { __name: "SectionWelcome" });
...
const __nuxt_component_4_lazy = defineAsyncComponent(() => import('./order-C0qIo3Ch.mjs').then((c) => c.default || c));
