import { a as useAppConfig, $ as $fetch$2 } from '../virtual/entry.mjs';
import { u as useComponentProps, t as tv, a as useForwardProps, P as Primitive, _ as _sfc_main$3 } from './Button-D5UK4P4A.mjs';
import { _ as _sfc_main$1 } from './Modal-BqSeB7U2.mjs';
import { _ as _sfc_main$1$1, a as _sfc_main$4 } from './FormField-B9FP6L9G.mjs';
import { u as useLazyFetch } from './fetch-DUhcUvKg.mjs';
import { _ as _sfc_main$5 } from './Input-BoJ6XMWD.mjs';
import { u as useLocale } from './useLocale-Cji6XXXY.mjs';
import { _ as _sfc_main$2 } from './DropdownMenu-kN0VmW8m.mjs';
...
import { z as upperFirst, p as defu } from '../nitro/nitro.mjs';
...
//#region app/components/direction/update.vue?vue&type=script&setup=true&lang.ts
var update_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	__name: "update",
	...
	setup(__props, { emit: __emit }) {
		...
		const onSubmit = async () => {
			loading.value = true;
			await $fetch$2(`/api/direction/${props.direction.id}`, {
				method: "PUT",
				body: { ...form }
			}).then(() => {
				emit("close");
...
//#endregion
//#region app/components/direction/update.vue
var _sfc_setup$2 = update_vue_vue_type_script_setup_true_lang_default.setup;
update_vue_vue_type_script_setup_true_lang_default.setup = (props, ctx) => {
	const ssrContext = useSSRContext();
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/direction/update.vue");
	return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
var update_default = Object.assign(update_vue_vue_type_script_setup_true_lang_default, { __name: "DirectionUpdate" });
//#endregion
...
var index_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			const _component_DirectionUpdate = update_default;
			...
			_push(ssrRenderComponent(_component_UModal, {
				...
				body: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(ssrRenderComponent(_component_DirectionUpdate, {
						direction: unref(currentSelectedDirection),
						onClose: ($event) => openModalUpdateDirection.value = false
					}, null, _parent, _scopeId));
					else return [createVNode(_component_DirectionUpdate, {
						direction: unref(currentSelectedDirection),
						onClose: ($event) => openModalUpdateDirection.value = false
