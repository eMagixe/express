...
const _sfc_main$k = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(props.chip ? _sfc_main$l : unref(Primitive)), mergeProps({
        as: as.value.root
          ...
          if (_push2) {
            ...
            return [
              __props.custom ? renderSlot(_ctx.$slots, "default", mergeProps({ key: 0 }, {
                ...
                isExternal,
                active: isLinkActive({ route: linkRoute, isActive, isExactActive })
              })) : (openBlock(), createBlock(_sfc_main$j, mergeProps({ key: 1 }, {
                ..._ctx.$attrs,
                ...__props.exact && isExactActive ? { "aria-current": props.ariaCurrentValue } : {},
                as: __props.as,
                type: __props.type,
      ...
      _push(ssrRenderComponent(unref(ToastRoot), mergeProps({
        ...
        default: withCtx(({ remaining, duration, open }, _push2, _parent2, _scopeId) => {
          if (_push2) {
                    ...
                    if (_push3) {
                      ...
                      return [
                        renderSlot(_ctx.$slots, "close", { ui: ui.value }, () => [
                          __props.close ? (openBlock(), createBlock(_sfc_main$h, mergeProps({
                            key: 0,
                            icon: __props.closeIcon || unref(appConfig2).ui.icons.close,
                            color: "neutral",
                            variant: "link",
            ...
            return [
              renderSlot(_ctx.$slots, "leading", { ui: ui.value }, () => [
                __props.avatar ? (openBlock(), createBlock(_sfc_main$k, mergeProps({
                  key: 0,
                  size: props.ui?.avatarSize || ui.value.avatarSize()
                }, __props.avatar, {
                  "data-slot": "avatar",
...
const UToaster = Object.assign(_sfc_main$e, { __name: "UToaster" });
...
const __nuxt_component_0$2 = Object.assign(_sfc_main$c, { __name: "UApp" });
const theme$4 = {
                                ...
                                _push4(ssrRenderComponent(unref(DialogClose), { "as-child": "" }, {
                                  default: withCtx((_3, _push5, _parent5, _scopeId4) => {
                                    if (_push5) {
                                      ...
                                      return [
                                        renderSlot(_ctx.$slots, "close", { ui: ui.value }, () => [
                                          props.close ? (openBlock(), createBlock(_sfc_main$h, mergeProps({
                                            key: 0,
                                            icon: __props.closeIcon || unref(appConfig2).ui.icons.close,
                                            color: "neutral",
                                            variant: "ghost",
          ...
          if (_push2) {
            ...
            return [
              renderSlot(_ctx.$slots, "toggle", {
                ...
                __props.toggle ? (openBlock(), createBlock(_sfc_main$h, mergeProps({
                  key: 0,
                  color: "neutral",
                  variant: "ghost",
                  "aria-label": open.value ? unref(t)("header.close") : unref(t)("header.open"),
...
const __nuxt_component_0 = Object.assign(_sfc_main$2, { __name: "SectionTitle" });
...
const __nuxt_component_4_lazy = defineAsyncComponent(() => import('./reviews-BsXSi5Pl.mjs').then((c) => c.default || c));
const __nuxt_component_5_lazy = defineAsyncComponent(() => import('./order-CLHJUPUK.mjs').then((c) => c.default || c));
const __nuxt_component_6_lazy = defineAsyncComponent(() => import('./footer-Dk-WvFMc.mjs').then((c) => c.default || c));
const _sfc_main = {};
...
//# sourceMappingURL=index-CEtuMSNm.mjs.map
