...
import { _ as _sfc_main$1$1, a as _sfc_main$6, L as Label_default } from './FormField-d80xNFAn.mjs';
...
import { _ as _sfc_main$8, i as isValueEqualOrExist } from './Popover-r8hguMv2.mjs';
import { o as onPrehydrate } from './fetch-Cprs8gzJ.mjs';
      ...
      if (unref(config).public.orderVisible) {
        ...
        if (!unref(isOrderCreated)) {
          _push(ssrRenderComponent(_component_UForm, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="flex flex-col lg:grid lg:grid-cols-2 justify-start items-center lg:items-start gap-5" data-v-502ed42b${_scopeId}>`);
                ...
                _push2(`<div class="date-time w-full flex not-sm:flex-col justify-start items-center gap-5" data-v-502ed42b${_scopeId}>`);
                              ...
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  if (unref(orderData).date) {
                                    ...
                                    _push5(`<p data-v-502ed42b${_scopeId4}>Выберете дату</p>`);
                                  }
                                } else {
                                  return [
                ...
                _push2(`</div><div class="min-w-[320px] max-w-110 flex flex-col justify-center items-center" data-v-502ed42b${_scopeId}>`);
                ...
                _push2(`</div></div><div class="w-full flex flex-row justify-center items-center pt-5 mb-20 gap-5" data-v-502ed42b${_scopeId}>`);
...
const __nuxt_component_1 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-502ed42b"]]), { __name: "OrderCreate" });
