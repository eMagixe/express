...
import { u as useForwardPropsEmits, a as useDirection, b as useArrowNavigation, P as PopperRoot_default, c as PopperAnchor_default, d as PopperArrow_default, e as PopperContent_default, f as useGraceArea } from './useFilter-BDnhBvLL.mjs';
import { _ as _sfc_main$4, e as _sfc_main$3$1, u as useComponentProps, t as tv, P as Primitive, a as useForwardProps, j as isArrayOfArray, k as _sfc_main$4$1, b as _sfc_main$5$1, f as get, c as _sfc_main$1$1, p as pickLinkProps, d as _sfc_main$2$1, F as FieldGroupReset, m as createContext, n as useForwardProps$1 } from './Button-D5UK4P4A.mjs';
import { u as useId$1, V as VisuallyHidden_default, a as usePortal, P as Presence_default, g as getActiveElement, T as Teleport_default, D as DismissableLayer_default } from './overlay-CnuoVSfw.mjs';
import { _ as _sfc_main$9, i as isValueEqualOrExist } from './Popover-reAmjTCC.mjs';
import { u as useForwardExpose } from './useForwardExpose-lTVrimVg.mjs';
import { u as useCollection } from './Collection-CMR0dnYu.mjs';
import { _ as _sfc_main$6 } from './Modal-BqSeB7U2.mjs';
import { _ as _sfc_main$7, i as injectTooltipProviderContext } from './Slideover-CkTj-WSe.mjs';
import { u as useLocale } from './useLocale-Cji6XXXY.mjs';
import { _ as _sfc_main$5 } from './Drawer-DirMqvds.mjs';
import { _ as _sfc_main$8 } from './Badge-Cz_GlsYG.mjs';
import { _ as _sfc_main$3, a as _sfc_main$2$2 } from './DropdownMenu-kN0VmW8m.mjs';
...
//#endregion
//#region node_modules/reka-ui/dist/NavigationMenu/NavigationMenuIndicator.js
...
//#endregion
//#region virtual:nuxt:node_modules%2F.cache%2Fnuxt%2F.nuxt%2Fui%2Fsidebar.ts
var virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Fui_2Fsidebar_default = {
	"slots": {
	...
	"variants": {
		...
		"collapsible": {
			...
			"none": { "root": "h-full w-(--sidebar-width)" }
		},
		"variant": {
			"sidebar": {},
			"floating": {
	...
	"compoundVariants": [
		{
			...
			"class": { "rail": "cursor-w-resize rtl:cursor-e-resize data-[state=collapsed]:cursor-e-resize data-[state=collapsed]:rtl:cursor-w-resize" }
		},
		{
			"side": "right",
			"collapsible": ["offcanvas", "icon"],
			"class": { "rail": "cursor-e-resize rtl:cursor-w-resize data-[state=collapsed]:cursor-w-resize data-[state=collapsed]:rtl:cursor-e-resize" }
		},
		{
			"side": "left",
			"collapsible": "none",
			"class": { "root": "border-e border-default" }
		},
		{
			"side": "right",
			"collapsible": "none",
			"class": { "root": "border-s border-default" }
		},
		{
			"side": "left",
			"collapsible": "offcanvas",
			"class": { "container": "data-[state=collapsed]:-start-(--sidebar-width)" }
		},
		{
			"side": "right",
			"collapsible": "offcanvas",
			"class": { "container": "data-[state=collapsed]:-end-(--sidebar-width)" }
		},
		{
			"variant": "floating",
			"collapsible": "icon",
		...
		},
		{
			"variant": "floating",
			"collapsible": "none",
			"class": { "root": "p-4 border-0" }
		},
		{
			"variant": "inset",
			"collapsible": "none",
			"class": { "root": "py-4 border-0" }
		},
		{
			"variant": "floating",
			"side": "left",
		...
		},
		{
			"variant": "floating",
			"side": "right",
			"class": { "rail": "start-[calc(--spacing(4)-1px)]" }
		}
	]
};
//#endregion
//#region node_modules/@nuxt/ui/dist/runtime/components/Sidebar.vue
var _sfc_main$2 = /*@__PURE__*/ Object.assign({ inheritAttrs: false }, {
	...
	setup(__props) {
		...
		const open = computed({
			...
			set: (value) => {
				if (isMobile.value) openMobile.value = value;
				else modelOpen.value = value;
			}
		});
		watch(isMobile, (mobile) => {
			...
			} else modelOpen.value = desktopOpen.value;
		}, { immediate: true });
		watch(modelOpen, (value) => {
			if (isMobile.value) openMobile.value = value;
		});
		watch(openMobile, (value) => {
			if (isMobile.value) modelOpen.value = value;
		});
		const { t } = useLocale();
		...
		const ui = computed(() => tv({
			extend: virtual_nuxt_node_modules_2F_cache_2Fnuxt_2F_nuxt_2Fui_2Fsidebar_default,
		...
		}, props.mode === "modal" ? {} : props.mode === "slideover" ? {
			side: props.side,
			inset: props.variant === "inset"
		} : {}));
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(ssrRenderComponent(unref(DefineContentTemplate), null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
							...
							ssrRenderSlot(_ctx.$slots, "header", {
								...
								if (unref(props).title || !!slots.title || unref(props).description || !!slots.description) {
									...
									if (unref(props).title || !!slots.title) {
										_push(`<p data-slot="title" class="${ssrRenderClass(ui.value.title({ class: unref(props).ui?.title }))}"${_scopeId}>`);
								...
								if (!!slots.actions || canClose.value) {
									...
									ssrRenderSlot(_ctx.$slots, "actions", { state: state.value }, null, _push, _parent, _scopeId);
									ssrRenderSlot(_ctx.$slots, "close", {
										state: state.value,
										ui: ui.value
									}, () => {
										if (canClose.value) _push(ssrRenderComponent(_sfc_main$4, mergeProps({
						...
						}, [renderSlot(_ctx.$slots, "title", { state: state.value }, () => [createTextVNode(toDisplayString(unref(props).title), 1)])], 2)) : createCommentVNode("", true), unref(props).description || !!slots.description ? (openBlock(), createBlock("p", {
							key: 1,
							"data-slot": "description",
							class: ui.value.description({ class: unref(props).ui?.description })
						}, [renderSlot(_ctx.$slots, "description", { state: state.value }, () => [createTextVNode(toDisplayString(unref(props).description), 1)])], 2)) : createCommentVNode("", true)], 2)) : createCommentVNode("", true), !!slots.actions || canClose.value ? (openBlock(), createBlock("div", {
							key: 1,
							"data-slot": "actions",
							class: ui.value.actions({ class: unref(props).ui?.actions })
						}, [renderSlot(_ctx.$slots, "actions", { state: state.value }), renderSlot(_ctx.$slots, "close", {
							state: state.value,
							ui: ui.value
						}, () => [canClose.value ? (openBlock(), createBlock(_sfc_main$4, mergeProps({
							key: 0,
							icon: unref(props).closeIcon || unref(appConfig).ui.icons.close,
							color: "neutral",
							variant: "ghost",
			...
			_push(ssrRenderComponent(unref(DefineInnerTemplate), null, {
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div data-slot="inner" class="${ssrRenderClass(ui.value.inner({ class: unref(props).ui?.inner }))}"${_scopeId}>`);
					...
					}, [createVNode(unref(ReuseContentTemplate))], 2)];
				}),
				_: 1
			}, _parent));
			if (unref(props).collapsible === "none") _push(ssrRenderComponent(unref(Primitive), mergeProps({
				as: unref(props).as,
				"data-slot": "root"
			}, _ctx.$attrs, {
				...
				default: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(ssrRenderComponent(unref(ReuseInnerTemplate), null, null, _parent, _scopeId));
					else return [createVNode(unref(ReuseInnerTemplate))];
				}),
				_: 1
			}, _parent));
			else {
				...
				_push(ssrRenderComponent(unref(Primitive), mergeProps({
					...
					default: withCtx((_, _push, _parent, _scopeId) => {
						if (_push) {
							_push(`<div data-slot="gap"${ssrRenderAttr("data-state", state.value)} class="${ssrRenderClass(ui.value.gap({ class: unref(props).ui?.gap }))}"${_scopeId}></div><div data-slot="container"${ssrRenderAttr("data-state", state.value)} class="${ssrRenderClass(ui.value.container({ class: unref(props).ui?.container }))}"${_scopeId}>`);
							_push(ssrRenderComponent(unref(ReuseInnerTemplate), null, null, _parent, _scopeId));
							if (unref(props).rail) ssrRenderSlot(_ctx.$slots, "rail", {
								state: state.value,
								ui: ui.value
							}, () => {
								_push(`<button data-slot="rail"${ssrRenderAttr("data-state", state.value)}${ssrRenderAttr("aria-label", unref(t)("sidebar.toggle"))}${ssrRenderAttr("tabindex", -1)} class="${ssrRenderClass(ui.value.rail({ class: unref(props).ui?.rail }))}"${_scopeId}></button>`);
							}, _push, _parent, _scopeId);
							else _push(`<!---->`);
							_push(`</div>`);
						} else return [createVNode("div", {
						...
						}, null, 10, ["data-state"]), createVNode("div", {
							"data-slot": "container",
							"data-state": state.value,
							class: ui.value.container({ class: unref(props).ui?.container })
						}, [createVNode(unref(ReuseInnerTemplate)), unref(props).rail ? renderSlot(_ctx.$slots, "rail", {
							state: state.value,
							ui: ui.value
						}, () => [createVNode("button", {
							"data-slot": "rail",
							...
							"aria-label",
							"onClick"
						])], void 0, 0) : createCommentVNode("", true)], 10, ["data-state"])];
					}),
					_: 3
				}, _parent));
				if (isMobile.value) _push(ssrRenderComponent(unref(Menu), mergeProps({
					open: openMobile.value,
					"onUpdate:open": ($event) => openMobile.value = $event
				}, menuProps.value), {
					content: withCtx((contentData, _push, _parent, _scopeId) => {
						if (_push) ssrRenderSlot(_ctx.$slots, "content", mergeProps(contentData, { close: closeSidebar }), () => {
							_push(ssrRenderComponent(unref(ReuseContentTemplate), null, null, _parent, _scopeId));
						}, _push, _parent, _scopeId);
						else return [renderSlot(_ctx.$slots, "content", mergeProps(contentData, { close: closeSidebar }), () => [createVNode(unref(ReuseContentTemplate))])];
					}),
					_: 3
				}, _parent));
				else _push(`<!---->`);
...
//#endregion
//#region node_modules/@nuxt/ui/dist/runtime/components/NavigationMenu.vue
				...
				default: withCtx(({ item, active, index }, _push, _parent, _scopeId) => {
					if (_push) ssrRenderSlot(_ctx.$slots, item.slot || "item", {
						...
						ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-leading` : "item-leading", {
							...
							if (item.avatar) _push(ssrRenderComponent(_sfc_main$3$1, mergeProps({ size: item.ui?.linkLeadingAvatarSize || unref(props).ui?.linkLeadingAvatarSize || ui.value.linkLeadingAvatarSize() }, item.avatar, {
							...
							else if (item.icon && item.chip) _push(ssrRenderComponent(_sfc_main$4$1, mergeProps({
							...
							else if (item.icon) _push(ssrRenderComponent(_sfc_main$5$1, {
								name: item.icon,
								"data-slot": "linkLeadingIcon",
								class: ui.value.linkLeadingIcon({
									class: [unref(props).ui?.linkLeadingIcon, item.ui?.linkLeadingIcon],
						...
						if (unref(get)(item, unref(props).labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"]) {
							...
							if (item.target === "_blank" && unref(props).externalIcon !== false) _push(ssrRenderComponent(_sfc_main$5$1, {
						...
						if (item.badge || item.badge === 0 || unref(props).orientation === "horizontal" && (item.children?.length || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) || unref(props).orientation === "vertical" && item.children?.length || item.trailingIcon || !!slots[item.slot ? `${item.slot}-trailing` : "item-trailing"]) ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(props).orientation === "vertical" && item.children?.length && !unref(props).collapsed ? unref(AccordionTrigger_default) : "span"), {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-trailing` : "item-trailing", {
									...
									if (item.badge || item.badge === 0) _push(ssrRenderComponent(_sfc_main$8, mergeProps({
										color: "neutral",
										variant: "outline",
									...
									if (unref(props).orientation === "horizontal" && (item.children?.length || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) || unref(props).orientation === "vertical" && item.children?.length) _push(ssrRenderComponent(_sfc_main$5$1, {
									...
									else if (item.trailingIcon) _push(ssrRenderComponent(_sfc_main$5$1, {
									...
									"data-slot": "linkTrailingBadge",
									class: ui.value.linkTrailingBadge({ class: [unref(props).ui?.linkTrailingBadge, item.ui?.linkTrailingBadge] })
								}), null, 16, ["size", "class"])) : createCommentVNode("", true), unref(props).orientation === "horizontal" && (item.children?.length || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) || unref(props).orientation === "vertical" && item.children?.length ? (openBlock(), createBlock(_sfc_main$5$1, {
									key: 1,
									name: item.trailingIcon || unref(props).trailingIcon || unref(appConfig).ui.icons.chevronDown,
									"data-slot": "linkTrailingIcon",
									class: ui.value.linkTrailingIcon({
						...
						unref(get)(item, unref(props).labelKey) || !!slots[item.slot ? `${item.slot}-label` : "item-label"] ? (openBlock(), createBlock("span", {
							...
							active,
							index
						}, () => [createTextVNode(toDisplayString(unref(get)(item, unref(props).labelKey)), 1)]), item.target === "_blank" && unref(props).externalIcon !== false ? (openBlock(), createBlock(_sfc_main$5$1, {
							key: 0,
							name: typeof unref(props).externalIcon === "string" ? unref(props).externalIcon : unref(appConfig).ui.icons.external,
							"data-slot": "linkLabelExternalIcon",
							class: ui.value.linkLabelExternalIcon({
						...
						default: withCtx((_, _push, _parent, _scopeId) => {
							if (_push) {
								if (unref(props).orientation === "vertical" && item.type === "label" && !unref(props).collapsed) {
									...
									_push(`</div>`);
								} else if (item.type !== "label") _push(ssrRenderComponent(_sfc_main$1$1, mergeProps(unref(props).orientation === "vertical" && item.children?.length && !unref(props).collapsed && item.type === "trigger" ? {} : unref(pickLinkProps)(item), { custom: "" }), {
									default: withCtx(({ active, ...slotProps }, _push, _parent, _scopeId) => {
										if (_push) {
											ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(props).orientation === "horizontal" && (item.children?.length || !!slots[item.slot ? `${item.slot}-content` : "item-content"]) ? unref(NavigationMenuTrigger_default) : unref(props).orientation === "vertical" && item.children?.length && !unref(props).collapsed && !slotProps.href ? unref(AccordionTrigger_default) : unref(NavigationMenuLink_default)), {
												...
												default: withCtx((_, _push, _parent, _scopeId) => {
													if (_push) {
														if (unref(props).orientation === "vertical" && unref(props).collapsed && item.children?.length && (!!unref(props).popover || !!item.popover)) _push(ssrRenderComponent(_sfc_main$9, mergeProps({
															...popoverProps.value,
															...
															content: withCtx(({ close }, _push, _parent, _scopeId) => {
																if (_push) ssrRenderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
																	...
																	ssrRenderList(item.children, (childItem, childIndex) => {
																		...
																		_push(ssrRenderComponent(_sfc_main$1$1, mergeProps({ ref_for: true }, unref(pickLinkProps)(childItem), { custom: "" }), {
																			default: withCtx(({ active: childActive, ...childSlotProps }, _push, _parent, _scopeId) => {
																				if (_push) _push(ssrRenderComponent(unref(NavigationMenuLink_default), {
																					...
																					default: withCtx((_, _push, _parent, _scopeId) => {
																						if (_push) _push(ssrRenderComponent(_sfc_main$2$1, mergeProps({ ref_for: true }, childSlotProps, {
																							"data-slot": "childLink",
																							...
																							default: withCtx((_, _push, _parent, _scopeId) => {
																								if (_push) {
																									if (childItem.icon) _push(ssrRenderComponent(_sfc_main$5$1, {
																										name: childItem.icon,
																									...
																									if (childItem.target === "_blank" && unref(props).externalIcon !== false) _push(ssrRenderComponent(_sfc_main$5$1, {
																										name: typeof unref(props).externalIcon === "string" ? unref(props).externalIcon : unref(appConfig).ui.icons.external,
																									...
																									_push(`</span>`);
																								} else return [childItem.icon ? (openBlock(), createBlock(_sfc_main$5$1, {
																									key: 0,
																									name: childItem.icon,
																									"data-slot": "childLinkIcon",
																									class: ui.value.childLinkIcon({
																								...
																								}, [createTextVNode(toDisplayString(unref(get)(childItem, unref(props).labelKey)) + " ", 1), childItem.target === "_blank" && unref(props).externalIcon !== false ? (openBlock(), createBlock(_sfc_main$5$1, {
																									key: 0,
																									name: typeof unref(props).externalIcon === "string" ? unref(props).externalIcon : unref(appConfig).ui.icons.external,
																									"data-slot": "childLinkLabelExternalIcon",
																									class: ui.value.childLinkLabelExternalIcon({
																						...
																						else return [createVNode(_sfc_main$2$1, mergeProps({ ref_for: true }, childSlotProps, {
																							"data-slot": "childLink",
																							class: ui.value.childLink({
																								class: [
																									unref(props).ui?.childLink,
																							...
																							default: withCtx(() => [childItem.icon ? (openBlock(), createBlock(_sfc_main$5$1, {
																								key: 0,
																								name: childItem.icon,
																								"data-slot": "childLinkIcon",
																								class: ui.value.childLinkIcon({
																					...
																					default: withCtx(() => [createVNode(_sfc_main$2$1, mergeProps({ ref_for: true }, childSlotProps, {
																						"data-slot": "childLink",
																						class: ui.value.childLink({
																							class: [
																								unref(props).ui?.childLink,
															...
															default: withCtx((_, _push, _parent, _scopeId) => {
																if (_push) _push(ssrRenderComponent(_sfc_main$2$1, mergeProps(slotProps, {
																	"data-slot": "link",
																	class: ui.value.link({
																		class: [
																			unref(props).ui?.link,
																...
																else return [createVNode(_sfc_main$2$1, mergeProps(slotProps, {
																	"data-slot": "link",
																	class: ui.value.link({
																		class: [
																			unref(props).ui?.link,
														...
														else if (unref(props).orientation === "vertical" && unref(props).collapsed && (!!unref(props).tooltip || !!item.tooltip) || unref(props).orientation === "horizontal" && !!item.tooltip) _push(ssrRenderComponent(_sfc_main$1, mergeProps({ text: unref(get)(item, unref(props).labelKey) }, {
															...tooltipProps.value,
														...
														else _push(ssrRenderComponent(_sfc_main$2$1, mergeProps(slotProps, {
															"data-slot": "link",
															class: ui.value.link({
																class: [
																	unref(props).ui?.link,
													...
													} else return [unref(props).orientation === "vertical" && unref(props).collapsed && item.children?.length && (!!unref(props).popover || !!item.popover) ? (openBlock(), createBlock(_sfc_main$9, mergeProps({ key: 0 }, {
														...popoverProps.value,
														...typeof item.popover === "boolean" ? {} : item.popover || {}
													}, { ui: { content: ui.value.content({ class: [unref(props).ui?.content, item.ui?.content] }) } }), {
														...
														default: withCtx(() => [createVNode(_sfc_main$2$1, mergeProps(slotProps, {
															"data-slot": "link",
															class: ui.value.link({
																class: [
																	unref(props).ui?.link,
														...
														_: 2
													}, 1040, ["ui"])) : unref(props).orientation === "vertical" && unref(props).collapsed && (!!unref(props).tooltip || !!item.tooltip) || unref(props).orientation === "horizontal" && !!item.tooltip ? (openBlock(), createBlock(_sfc_main$1, mergeProps({
														key: 1,
											...
											default: withCtx(() => [unref(props).orientation === "vertical" && unref(props).collapsed && item.children?.length && (!!unref(props).popover || !!item.popover) ? (openBlock(), createBlock(_sfc_main$9, mergeProps({ key: 0 }, {
												...popoverProps.value,
												...typeof item.popover === "boolean" ? {} : item.popover || {}
											}, { ui: { content: ui.value.content({ class: [unref(props).ui?.content, item.ui?.content] }) } }), {
												content: withCtx(({ close }) => [renderSlot(_ctx.$slots, item.slot ? `${item.slot}-content` : "item-content", {
								...
								item,
								index
							}, null, 8, ["item", "index"])], 2)) : item.type !== "label" ? (openBlock(), createBlock(_sfc_main$1$1, mergeProps({ key: 1 }, unref(props).orientation === "vertical" && item.children?.length && !unref(props).collapsed && item.type === "trigger" ? {} : unref(pickLinkProps)(item), { custom: "" }), {
...
var dashboard_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			const _component_USidebar = _sfc_main$2;
			...
			_push(ssrRenderComponent(_component_USidebar, {
				...
				header: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(` ЭКСПРЕСС `);
					} else return [createVNode(_component_UAvatar, {
						src: "/favicon.png",
						ui: { root: "w-12 h-12" }
				...
				default: withCtx(({ state }, _push, _parent, _scopeId) => {
					if (_push) {
						if (state === "expanded") _push(`<h3 class="mt-5"${_scopeId}>Общее</h3>`);
						else _push(`<!---->`);
					...
					} else return [state === "expanded" ? (openBlock(), createBlock("h3", {
						key: 0,
						class: "mt-5"
					}, "Общее")) : createCommentVNode("", true), (openBlock(), createBlock(_component_UNavigationMenu, {
						key: ("useId" in _ctx ? _ctx.useId : unref(useId))(),
						items: getItemsAll(state),
						orientation: "vertical",
						ui: { link: "p-1.5 overflow-hidden text-gray-700 hover:bg-gray-400 rounded-lg" }
				...
				footer: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) {
						if (unref(auth).getUser()) _push(ssrRenderComponent(_component_UDropdownMenu, {
							...
							default: withCtx((_, _push, _parent, _scopeId) => {
								if (_push) _push(ssrRenderComponent(_component_UButton, mergeProps(unref(auth).getUser(), {
								...
								else return [createVNode(_component_UButton, mergeProps(unref(auth).getUser(), {
									label: unref(auth).getUser()?.full_name,
									"trailing-icon": "i-lucide-chevrons-up-down",
									color: "neutral",
									variant: "ghost",
					...
					} else return [unref(auth).getUser() ? (openBlock(), createBlock(_component_UDropdownMenu, {
						key: 0,
						items: unref(userItems),
						content: {
							align: "center",
						...
						default: withCtx(() => [createVNode(_component_UButton, mergeProps(unref(auth).getUser(), {
							label: unref(auth).getUser()?.full_name,
							"trailing-icon": "i-lucide-chevrons-up-down",
							color: "neutral",
							variant: "ghost",
