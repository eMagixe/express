...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "welcome-section w-full mx-auto" }, _attrs))} data-v-7ce17cd4>`);
  _push(ssrRenderComponent(_component_UContainer, { class: "h-[calc(100vh-100px)] min-h-160 flex flex-col justify-start gap-5 pt-10" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="cities-list w-full flex flex-row justify-center items-center gap-10" data-v-7ce17cd4${_scopeId}>`);
        ...
        _push2(`</div><p class="text-sm text-gray-400" data-v-7ce17cd4${_scopeId}>* требуется дополнительная оплата</p><h2 class="font-medium text-[clamp(1.25rem,3vw,3rem)] text-white text-center lg:text-left w-full lg:w-[70%]" data-v-7ce17cd4${_scopeId}> Круглосуточные перевозки </h2>`);
        ...
        _push2(`<div class="text-[clamp(1rem,3vw,2rem)] border-t-3 border-t-primary/20 pt-10 text-white text-center lg:text-left w-full lg:w-[60%]" data-v-7ce17cd4${_scopeId}> Быстро и с комфортом доставим вас в нужное место в любое время дня и ночи </div>`);
      } else {
        return [
...
const __nuxt_component_0 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-7ce17cd4"]]), { __name: "SectionWelcome" });
