...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"yandex-verification","content":"a20d3bdc1ac81b9a"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.png"},{"rel":"canonical","href":"https://taxi-express.su"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"ru"}};
