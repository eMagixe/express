...
import { b as buildAssetsURL, u as useRuntimeConfig, g as getResponseStatusText, a as getResponseStatus, e as decodePath, f as defineRenderHandler, p as publicAssetsURL, h as getQuery, c as createError, i as destr, j as getRouteRules, k as joinURL, l as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"yandex-verification","content":"a20d3bdc1ac81b9a"},{"name":"robots","content":"index, follow"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.png"}],"style":[],"script":[{"src":"/js/yandex-metrika.js","tagPosition":"bodyClose","defer":true}],"noscript":[],"htmlAttrs":{"lang":"ru"}};
